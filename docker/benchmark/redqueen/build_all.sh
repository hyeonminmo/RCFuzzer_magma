...

{
     cd /rcfuzz_bench/magma/libsndfile && \
        cp sndfile_aflpp /d/p/aflclangfast/magma/libsndfile/libsndfile && \
        cp sndfile_cmplog /d/p/aflclangfastcmplog/magma/libsndfile/libsndfile
} &

{
     cd /rcfuzz_bench/magma/libtiff-read_rgba && \
        cp libtiff-read_rgba_aflpp /d/p/aflclangfast/magma/libtiff-read_rgba/libtiff-read_rgba && \
        cp libtiff-read_rgba_cmplog /d/p/aflclangfastcmplog/magma/libtiff-read_rgba/libtiff-read_rgba
} &

{
     cd /rcfuzz_bench/magma/libtiff-tiffcp && \
        cp libtiff-tiffcp_aflpp /d/p/aflclangfast/magma/libtiff-tiffcp/libtiff-tiffcp && \
        cp libtiff-tiffcp_cmplog /d/p/aflclangfastcmplog/magma/libtiff-tiffcp/libtiff-tiffcp
} &

{
     cd /rcfuzz_bench/magma/lua && \
        cp liblua_aflpp.a /d/p/aflclangfast/magma/lua/liblua.a && \
        cp lua_aflpp /d/p/aflclangfast/magma/lua/lua && \
        cp liblua_cmplog.a /d/p/aflclangfastcmplog/magma/lua/liblua.a && \
        cp lua_cmplog /d/p/aflclangfastcmplog/magma/lua/lua
} &

{
     cd /rcfuzz_bench/magma/php-exif && \
        cp exif_aflpp /d/p/aflclangfast/magma/php-exif/php-exif && \
        cp exif_cmplog /d/p/aflclangfastcmplog/magma/php-exif/php-exif
} &

{
     cd /rcfuzz_bench/magma/php-json && \
        cp json_aflpp /d/p/aflclangfast/magma/php-json/php-json && \
        cp json_cmplog /d/p/aflclangfastcmplog/magma/php-json/php-json
} &

{
     cd /rcfuzz_bench/magma/php-parser && \
        cp parser_aflpp /d/p/aflclangfast/magma/php-parser/php-parser && \
        cp parser_cmplog /d/p/aflclangfastcmplog/magma/php-parser/php-parser
} &

{
     cd /rcfuzz_bench/magma/php-unserialize && \
        cp unserialize_aflpp /d/p/aflclangfast/magma/php-unserialize/php-unserialize && \
        cp unserialize_cmplog /d/p/aflclangfastcmplog/magma/php-unserialize/php-unserialize
} &

{
     cd /rcfuzz_bench/magma/poppler-pdf && \
        cp poppler-pdf_aflpp /d/p/aflclangfast/magma/poppler-pdf/poppler-pdf && \
        cp poppler-pdf_cmplog /d/p/aflclangfastcmplog/magma/poppler-pdf/poppler-pdf
} &

{
     cd /rcfuzz_bench/magma/poppler-pdfimage && \
        cp poppler-pdfimage_aflpp /d/p/aflclangfast/magma/poppler-pdfimage/poppler-pdfimage && \
        cp poppler-pdfimage_cmplog /d/p/aflclangfastcmplog/magma/poppler-pdfimage/poppler-pdfimage
} &

{
     cd /rcfuzz_bench/magma/poppler-pdftoppm && \
        cp poppler-pdftoppm_aflpp /d/p/aflclangfast/magma/poppler-pdftoppm/poppler-pdftoppm && \
        cp poppler-pdftoppm_cmplog /d/p/aflclangfastcmplog/magma/poppler-pdftoppm/poppler-pdftoppm
} &
