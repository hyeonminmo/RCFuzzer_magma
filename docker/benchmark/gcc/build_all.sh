...

{
     cd /rcfuzz_bench/magma/libsndfile && \
        cp sndfile_normal /d/p/normal/magma/libsndfile/libsndfile 
} &

{
     cd /rcfuzz_bench/magma/libtiff-read_rgba && \
        cp libtiff-read_rgba_normal /d/p/normal/magma/libtiff-read_rgba/libtiff-read_rgba 
} &

{
     cd /rcfuzz_bench/magma/libtiff-tiffcp && \
        cp libtiff-tiffcp_normal /d/p/normal/magma/libtiff-tiffcp/libtiff-tiffcp 
} &

{
     cd /rcfuzz_bench/magma/lua && \
        cp liblua_normal.a /d/p/normal/magma/lua/liblua.a && \
        cp lua_normal /d/p/normal/magma/lua/lua 
} &

{
     cd /rcfuzz_bench/magma/php-exif && \
        cp exif_normal /d/p/normal/magma/php-exif/php-exif 
} &

{
     cd /rcfuzz_bench/magma/php-json && \
        cp json_normal /d/p/normal/magma/php-json/php-json
} &

{
     cd /rcfuzz_bench/magma/php-parser && \
        cp parser_normal /d/p/normal/magma/php-parser/php-parser
} &

{
     cd /rcfuzz_bench/magma/php-unserialize && \
        cp unserialize_normal /d/p/normal/magma/php-unserialize/php-unserialize
} &

{
     cd /rcfuzz_bench/magma/poppler-pdf && \
        cp poppler-pdf_normal /d/p/normal/magma/poppler-pdf/poppler-pdf
} &

{
     cd /rcfuzz_bench/magma/poppler-pdfimage && \
        cp poppler-pdfimage_normal /d/p/normal/magma/poppler-pdfimage/poppler-pdfimage
} &

{
     cd /rcfuzz_bench/magma/poppler-pdftoppm && \
        cp poppler-pdftoppm_normal /d/p/normal/magma/poppler-pdftoppm/poppler-pdftoppm
} &
